...
interface ConstellationProps {
  ...
  pullRadius?: number;
  /** Star color as "r, g, b". Defaults to the burgundy signal. */
  color?: string;
  className?: string;
}
...
/**
 * The Infolitico constellation — a field of drifting points of light that
 * link to their nearest neighbours and gravitate toward the cursor. Rendered
 * on a <canvas> behind dead-end surfaces (the 404).
 *
