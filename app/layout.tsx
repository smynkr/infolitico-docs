...
const siteDescription =
  'Infolitico documentation — how the fully autonomous faith-framed news site reports today’s events and connects them to Scripture, reflection, and prayer.';

export const metadata: Metadata = {
  metadataBase: new URL('https://docs.infolitico.com'),
  applicationName: 'Infolitico Docs',
  title: {
    default: 'Infolitico Docs',
    template: '%s · Infolitico Docs',
  },
  ...
  openGraph: {
    ...
    title: { default: 'Infolitico Docs', template: '%s · Infolitico Docs' },
    description: siteDescription,
  },
  twitter: {
